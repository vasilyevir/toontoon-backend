...
# тарифу — квоту. ID товаров — как в App Store Connect (`week_9.99`, `year_59.99`,
# заведены до нас и не меняются); расхождение = покупка без квоты.
#
# Шкала с 8 сентября 2026 (Илья по пожеланиям Тимофея): любой кадр 15 монет,
# видео 175; Weekly $9.99 → 700 монет в неделю; Yearly $59.99. ID товаров в
# App Store Connect заведены заново под новые цены (week_9.99 / year_59.99):
# прежние week_6.99 и year_39.99 остались от первых тарифов (Илья, 2026-09-14)
# там, а не через новые товары; приложение берёт цену из App Store.
#
...
PLANS = [
    ...
    ("weekly", "week_9.99", "Weekly", "week", 999, 700, 10),
    ("yearly", "year_59.99", "Pro Unlimited", "year", 5999, 3000, 30),  # 3000 — на весь год, разово
]
