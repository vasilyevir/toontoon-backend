...
#
# Квоты пересчитаны от себестоимости 27 августа. Шкала с 7 сентября: любой
# кадр 10 монет (рисунок шёл за 20, пока его рисовал Gemini Pro вдвое дороже;
# теперь одна модель — одна цена), разговор 10, видео 175.
#
