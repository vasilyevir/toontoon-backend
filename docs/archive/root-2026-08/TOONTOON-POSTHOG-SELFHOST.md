# TOONTOON — PostHog self-host (аналитика продукта)
...
**Важно для TOONTOON:**
- Повесить за nginx на HTTPS-хост (напр. `https://analytics.toontoon.internal`
...
- `Config.xcconfig`: `TOONTOON_POSTHOG_KEY = phc_…`, `TOONTOON_POSTHOG_HOST = https:/$()/…`
