# Video v2.0 — фиксы (US-рынок, английский)

Версия: 1.0 | Дата: 2026-06-19 | Статус: Approved-draft
...
```
"Who's it for?"          👩 Woman · 👨 Man · 🧒 Kid · ✍️ Other   (персонализирует ТЕКСТ: "Happy Birthday, Mom!")
"What should it say?"     [default by occasion] · "Wishing you all the best" · ✍️ Other
...
- `video-greeting`: добавить вопрос `occasion` с 13 темами (см. §3) + маппинг дефолтного текста
  по поводу.
